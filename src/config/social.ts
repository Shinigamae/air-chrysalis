...
export const profiles: Profile[] = [
  ...
  {
    /*
     * No `href`, and that is the finished state rather than a gap.
     *
     * Discord has no username URL — `discord.com/users/…` takes the numeric
     * snowflake id and nothing else, and there is no public form that
     * resolves `shinigamae`. So the card shows the username, which is what
     * someone actually needs: Discord finds people by typing it into search.
     *
     * To make it a link instead: turn on Settings › Advanced › Developer
     * Mode, right-click your own avatar, Copy User ID, and add
     * `href: 'https://discord.com/users/<that number>'`. The card picks up
     * the arrow on its own.
     */
    key: 'discord',
    name: 'DISCORD',
    handle: '@shinigamae',
